...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | Web fundamentals — what's a servlet, container, request lifecycle | **DRAFT** | `DeepDive/01-web-fundamentals.md` ✅ | `Reference/01-web-fundamentals-reference.md` ✅ | reading + optional `nc -l 8080` hands-on | — | — |
| 2 | Servlet API + hello-world (v1 of growing app) | **DRAFT** | `DeepDive/02-servlet-api.md` ✅ | `Reference/02-servlet-api-reference.md` ✅ | `exercises/01-servlet-hello/` ✅ + `growing-app/v1-servlet/` ✅ (both verified end-to-end on Jetty) | — | — |
| 3 | IoC + DI part 1 — container, beans, ApplicationContext | TODO | `DeepDive/03-ioc-di-container.md` | `Reference/03-ioc-di-container-reference.md` | `exercises/02-bean-discovery/` | — | — |
| 4 | IoC + DI part 2 — DI types, scopes, bean lifecycle | TODO | `DeepDive/04-bean-lifecycle.md` | `Reference/04-bean-lifecycle-reference.md` | `exercises/03-bean-lifecycle/` | — | — |
| 5 | AOP & proxies — `@Transactional` self-call trap | TODO | `DeepDive/05-aop-and-proxies.md` | `Reference/05-aop-and-proxies-reference.md` | `exercises/04-aop-self-call-trap/` | — | — |
| 6 | Spring MVC — DispatcherServlet routing (v2 of growing app) | TODO | `DeepDive/06-spring-mvc.md` | `Reference/06-spring-mvc-reference.md` | `exercises/05-dispatcher-trace/` + `growing-app/v2-spring-mvc/` | — | — |
| 7 | Spring Boot auto-config — what `@SpringBootApplication` does (v3 of growing app) | TODO | `DeepDive/07-spring-boot-autoconfig.md` | `Reference/07-spring-boot-autoconfig-reference.md` | `exercises/06-autoconfig-peek/` + `growing-app/v3-spring-boot/` | — | — |
| 8 | Spring Boot deeper — properties, profiles, `@ConditionalOnMissingBean` | TODO | `DeepDive/08-properties-and-profiles.md` | `Reference/08-properties-and-profiles-reference.md` | `exercises/07-profiles-demo/` | — | — |
| 9 | Spring Data JPA + transaction propagation + lazy loading | TODO | `DeepDive/09-spring-data-jpa.md` | `Reference/09-spring-data-jpa-reference.md` | `exercises/08-jpa-lazy-loading/` | — | — |
| 10 | Consolidation + mock interview self-test | TODO | `DeepDive/10-consolidation.md` | `Reference/00-master-index.md` + `Reference/spring-annotations-cheatsheet.md` | walk all 3 growing-app versions, self-administered Q&A | — | — |
...
**Cross-link:** [`DeepDive/01-web-fundamentals.md` — §🔬 Optional 5-minute hands-on](DeepDive/01-web-fundamentals.md)
